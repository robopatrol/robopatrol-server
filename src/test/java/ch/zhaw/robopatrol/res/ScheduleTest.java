...
public class ScheduleTest {
    ...
    public void testToString(){
      ...
      assertThat(result, containsString("takePhoto="));
      assertThat(result, containsString("takePhotoIntervalSec="));
      ...
      assertThat(result, containsString(t1.isTakePhoto()));
      assertThat(result, containsString(t1.getTakePhotoIntervalSec()));
      assertThat(result, containsString(t1.isActive()));
    }
