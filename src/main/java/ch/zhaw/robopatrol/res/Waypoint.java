...
public class Waypoint {
    ...
    private static final RobopatrolStore STORE = RobopatrolStore.forClass(Waypoint.class);

    private final RobopatrolStore store;

    public Waypoint() {
        store = STORE;
    }

    public Waypoint(RobopatrolStore store) {
        this.store = store;
    }

    // TODO: Create proper entities. See Schedule.java for an example.
//    /**
//     *
